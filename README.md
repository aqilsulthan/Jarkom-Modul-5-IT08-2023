...
- Kode kedua dan keempat juga melakukan penerusan paket pada port yang sama (80 dan 443) ke alamat yang berbeda (192.237.1.118 dan 192.237.4.2).
![Foto](./img/7a.png)
...
Untuk melakukan logging kami melakukan port scanning, hal yang sama dengan no 9, lalu mengecek hasil lognya di `iptables -L`<br>
![Foto](./img/10.png)
